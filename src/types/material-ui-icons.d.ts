...
declare module "material-ui-icons/Menu" {
    class MenuIcon extends MaterialUI.SvgIcon { }
    export default MenuIcon;
}

declare module "material-ui-icons/ExitToApp" {
    class ExitToApp extends MaterialUI.SvgIcon { }
    export default ExitToApp;
}

declare module "material-ui-icons/Receipt" {
    class Receipt extends MaterialUI.SvgIcon { }
    export default Receipt;
}

declare module "material-ui-icons/Assignment" {
    class Assignment extends MaterialUI.SvgIcon { }
    export default Assignment;
}

declare module "material-ui-icons/Send" {
    class Send extends MaterialUI.SvgIcon { }
    export default Send;
}

declare module "material-ui-icons/ViewList" {
    class ViewList extends MaterialUI.SvgIcon { }
    export default ViewList;
}

declare module "material-ui-icons/Email" {
    class Email extends MaterialUI.SvgIcon { }
